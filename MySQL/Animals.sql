...
/*
В соответствии с диаграммой классов таблицы будут связаны ключами. При создании таблиц я буду использовать значения по умолчанию,
чтобы каждое животное в конечной таблице автоматически привязывалось к своему виду и типу животных. 
*/
...
CREATE TABLE IF NOT EXISTS Youngs( -- Создаем таблицу, куда будут помещены животные от 1 до 3 лет
 ...
 -- Создаем функцию, которая будет рассчитывать и красиво записывать возраст животных
DELIMITER // 
...
изначально было животное, `Type` - к какому типу относится. Эти данные были заданы по умолчанию при заполнении таблиц.
*/
...
/*
Работа выполнена при помощи MySQL Workbench, все команды проверены на работоспособность и правильность результатов.
*/